...
def main():
    parser = argparse.ArgumentParser(description="Run metrics calculation on all checkpoints in a directory")
    parser.add_argument("--ckpt_dir", type=str, required=True, help="Directory containing checkpoints")
    parser.add_argument("--data_path", type=str, required=True, help="Path to the dataset (miniImageNet)")
    parser.add_argument("--output_file", type=str, default="metrics_results.json", help="Output file for collected metrics")
    parser.add_argument("--batch_size", type=int, default=64, help="Batch size")
    parser.add_argument("--device", type=str, default="cuda", help="Device (cuda/cpu)")
    parser.add_argument("--script_path", type=str, default="ssl/calc_metrics.py", help="Path to calc_metrics.py script")

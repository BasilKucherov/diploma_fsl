...
def parse_args(script):
    ...
    parser.add_argument(
        ...
        "--names-list",
        nargs="+",
        default=["miniImageNet", "caltech256", "DTD", "cifar100", "CUB"],
        help="pretained model to use",
    )
    parser.add_argument(
        "--fine_tune_all_models",
        action="store_true",
        help="fine-tune each model before selection",
    ...
    if script == "train":
        ...
        parser.add_argument(
            "--stop_epoch", default=400, type=int, help="Stopping epoch"
